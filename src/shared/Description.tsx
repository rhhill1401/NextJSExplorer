...
function Description({ title, text, buttonName }: Props) {
  return (
    <div className="col-span-1  flex justify-center lg:justify-start items-center">
      ...
      >
        <div
          className="row-span-1  text-center lg:text-left  text-4xl lg:text-5xl text-cadiz-m text-zinc-900 font-medium
            "
        >
          {title}
        </div>
        <div className="row-span-2 max-h-fit text-center lg:text-left flex justify-center text-base lg:text-lg text-cadiz-no-color font-normal text-zinc-500 tracking-wide">
          {text}
        </div>
